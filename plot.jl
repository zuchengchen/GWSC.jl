...
"""
function plotCharacteristicStrain(lisa::LISA; figure_file=undef, 
...
"""
function plotSpectralDensity(lisa::LISA; figure_file=undef, 
        plotSn_WC=true, plotSn=false, plotPn=false, plotPn_WC=false, plotSnC=false)
